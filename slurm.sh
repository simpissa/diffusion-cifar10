...
#SBATCH -A CCR25016                      # Allocation name to charge job against
#SBATCH --mail-user=mzhao12@tacc.utexas.edu
...
singularity exec diffusion-cifar10_latest.sif ./run_docker.sh